...
public class AutoStartHelper {
    ...
    public void getSpecialPermission(Context context) {
        ...
        switch (build_info) {
            case BRAND_ASUS:
                ...
                break;
            case BRAND_XIAOMI:
                specialPerissionXiaomi(context);
                break;
            case BRAND_LETV:
                autoStartLetv(context);
                break;
...
//                    PrefUtil.writeBoolean(context, PrefUtil.PREF_KEY_APP_AUTO_START, true);
    ...
    private void specialPerissionXiaomi(final Context context) {
        if (isPackageExists(context, PACKAGE_XIAOMI_MAIN)) {
            showAlert(context, (dialog, which) -> {
                try {
//                    PrefUtil.writeBoolean(context, PrefUtil.PREF_KEY_APP_AUTO_START, true);
        ...
        inteset.putExtra("extra_pkgname", context.getPackageName());
        context.startActivity(inteset);
